 ...
 * Protected by rate limiting, superAdmin JWT authentication, and init-key verification.
 */
...
export async function POST(req: NextRequest) {
  ...
  // Require superAdmin authentication in all environments
  try {
    ...
    // If no auth header, fall through to x-init-key check below
  } catch {
  ...
  const createStatements = [
    ...
    `CREATE TABLE IF NOT EXISTS "Plan" (
      ...
      "priceUSD" NUMERIC(14,2) NOT NULL DEFAULT 0,
      "priceTTD" NUMERIC(14,2) NOT NULL DEFAULT 0,
    ...
    `CREATE TABLE IF NOT EXISTS "PlatformInvoice" (
      ...
      "tenantId" TEXT,
      "invoiceNumber" TEXT,
      "amountUSD" NUMERIC(14,2) NOT NULL DEFAULT 0,
      "amountTTD" NUMERIC(14,2) NOT NULL DEFAULT 0,
    ...
    `CREATE TABLE IF NOT EXISTS "PriceSetting" (
      ...
      "planId" TEXT,
      "key" TEXT NOT NULL,
      "valueUSD" NUMERIC(14,2) NOT NULL DEFAULT 0,
      "valueTTD" NUMERIC(14,2) NOT NULL DEFAULT 0,
      "updatedAt" TIMESTAMP(3) NOT NULL,
    ...
    `CREATE TABLE IF NOT EXISTS "Recipe" (
      ...
      "costPerServing" NUMERIC(14,2) NOT NULL DEFAULT 0,
    ...
    `CREATE TABLE IF NOT EXISTS "Ingredient" (
      ...
      "category" TEXT,
      "unit" TEXT,
      "costPerUnit" NUMERIC(14,2) NOT NULL DEFAULT 0,
    ...
    `CREATE TABLE IF NOT EXISTS "LegalCase" (
      ...
      "description" TEXT,
      "billingRate" NUMERIC(14,2) NOT NULL DEFAULT 0,
    ...
    `CREATE TABLE IF NOT EXISTS "Venue" (
      ...
      "pricePerHour" NUMERIC(14,2) NOT NULL DEFAULT 0,
      "isActive" BOOLEAN NOT NULL DEFAULT true,
      "isDeleted" BOOLEAN NOT NULL DEFAULT false,
      "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
      "updatedAt" TIMESTAMP(3) NOT NULL,
    ...
    `CREATE TABLE IF NOT EXISTS "PropertyUnit" (
      ...
      "baseRentTTD" NUMERIC(14,2) NOT NULL DEFAULT 0,
      "baseRentUSD" NUMERIC(14,2) NOT NULL DEFAULT 0,
      "tenantId" TEXT,
    ...
    `CREATE TABLE IF NOT EXISTS "Lease" (
      ...
      "rentAmount" NUMERIC(14,2) NOT NULL DEFAULT 0,
    ...
    `CREATE TABLE IF NOT EXISTS "RentPayment" (
      ...
      "lateFee" NUMERIC(14,2) NOT NULL DEFAULT 0,
      "currency" TEXT NOT NULL DEFAULT 'TTD',
      "paymentMethod" TEXT,
      "paymentRef" TEXT,
      "status" TEXT NOT NULL DEFAULT 'pending',
    ...
    `CREATE TABLE IF NOT EXISTS "OwnerDisbursement" (
      ...
      "periodStart" TIMESTAMP(3) NOT NULL,
      "periodEnd" TIMESTAMP(3) NOT NULL,
      "grossIncome" NUMERIC(14,2) NOT NULL DEFAULT 0,
      ...
      "disbursementAmount" NUMERIC(14,2) NOT NULL DEFAULT 0,
      "currency" TEXT NOT NULL DEFAULT 'TTD',
      "status" TEXT NOT NULL DEFAULT 'pending',
      "paidAt" TIMESTAMP(3),
      "notes" TEXT,
    ...
    `CREATE TABLE IF NOT EXISTS "LeaseRenewalLog" (
      ...
      "oldRent" NUMERIC(14,2) NOT NULL DEFAULT 0,
      "newRent" NUMERIC(14,2) NOT NULL DEFAULT 0,
    ...
    `CREATE TABLE IF NOT EXISTS "CostAnalysis" (
      ...
      "suggestedPrice" NUMERIC(14,2) NOT NULL DEFAULT 0,
      "laborCost" NUMERIC(14,2) NOT NULL DEFAULT 0,
      "overheadCost" NUMERIC(14,2) NOT NULL DEFAULT 0,
    ...
    `CREATE TABLE IF NOT EXISTS "LoyaltyMember" (
      ...
      "totalSpent" NUMERIC(14,2) NOT NULL DEFAULT 0,
